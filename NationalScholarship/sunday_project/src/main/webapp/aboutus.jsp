...
<div class="header"><center>
    <div style="text-align: center">
			<img style="float: center; margin: 0px 0px 0px 0px;" src="emblem.jpg"
				height="80" width="80">
		</center>

		<h2>NATIONAL SCHOLARSHIP PORTAL</h2>
		<p>A DIGITAL INDIA PROGRAMME INITIATIVE</p>
</div></div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
       ...
       <li class="nav-item active"><a href="aboutus.jsp">ABOUT US</a></li>
	   <li><a href="institute.do">INSTITUTE REGISTRATION</a> </li>
	   <li><a href="register.do">NEW REGISTRATION</a></li>
        <li><a href="contactus.jsp">CONTACT US</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        
        <li><a href="slogin.do"><span class="glyphicon glyphicon-log-in"></span> LOGIN</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<h2 style="test-align:center;">About Us</h2>
<p>
<strong>National Scholarships Portal</strong>
is one-stop solution through which various services starting from student application, application receipt, processing, sanction and disbursal of various scholarships to Students are enabled. National Scholarships Portal is taken as Mission Mode Project under National e-Governance Plan (NeGP)
</p>
<h4>Vision</h4>
<p>
